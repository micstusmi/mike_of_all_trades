...
<body><?php $adminPageTitle='Invoice Preparation';$adminBreadcrumbs=['Work Tracker'=>'index.php','Invoice'=>''];$adminJob=$job??null;require __DIR__.'/../../includes/admin_nav.php';?>
<div class="wrap">
...
<?php if(($_GET['zoho_synced']??'')==='1'):?><div class="notice good"><b>✓ Zoho draft updated.</b> The supplier-GST information and current Work Tracker figures were synchronised. Nothing was emailed.</div><?php endif;?>
