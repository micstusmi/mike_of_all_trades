...
<main>
  ...
  <section id="workspace" hidden>
    ...
    <p id="identity"></p>
    <nav aria-label="Workspace"><button data-view="jobs">Jobs</button><button data-view="calendar">Quick booking</button><button data-view="customers">Customers</button><button data-view="sms">SMS drafts</button><button data-view="feedback">Feature requests</button><button data-view="usage">AI usage</button><button data-view="members">Members</button><button data-view="migration">Migration</button></nav>
