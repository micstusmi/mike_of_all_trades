...
<main>
    ...
    <div class="row g-4 text-center">
        <div class="col-md-3">
            <div class="card p-4 h-100 skill-card border-0 shadow-sm position-relative">
                ...
                <a href="media.php" class="stretched-link"></a>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card p-4 h-100 skill-card border-0 shadow-sm position-relative">
                ...
                <a href="tech.php" class="stretched-link"></a>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card p-4 h-100 skill-card border-0 shadow-sm position-relative">
                ...
                <a href="trades.php" class="stretched-link"></a>
            </div>
        </div>
    </div>
</main>
